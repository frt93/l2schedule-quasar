export default {
  ...
  hints: {
    settings: {
      ...
      email: 'Адрес электронной почты скрыт от остальных пользователей',
      password:
      ...
      safety: {
        enterEmail:
          'Чтобы снизить риск потери доступа к данному аккаунту - укажите ваш адрес электронной почты. \n Он будет скрыт от других пользователей',
        email1:
